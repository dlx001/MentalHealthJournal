...
const LoginPage = ()=>{
    return(<div>
        ...
        <div style={{display:"flex", flexDirection:"column",justifyContent:"center",alignItems:"center"}}>
            ...
            <div className="card" style={{display:"flex",marginBottom:"100px", width:"100%",justifyContent:"center"}}>
            ...
            <div className="card" style={{display:"flex",marginBottom:"100px",backgroundColor:"#FFD1DC",padding:"50px", width:"100%",justifyContent:"center"}}>
                <img src="./NotesExample.png" width="400px"></img>
